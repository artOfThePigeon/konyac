...
export declare class GetCampaignMessageResponseCompoundDocumentIncludedInner {
    'type': TemplateEnum;
    'id': string;
...
export declare namespace GetCampaignMessageResponseCompoundDocumentIncludedInner {
}
